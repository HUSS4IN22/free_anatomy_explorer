...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-4xl bg-popover p-1 text-popover-foreground font-patrick",
        className
      )}
      {...props}
    />
    ...
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-16 bg-input/30 rounded-4xl">
        <CommandPrimitive.Input
          ...
          className={cn(
            "w-full outline-hidden disabled:cursor-not-allowed disabled:opacity-50 text-2xl bg-transparent",
            className
          )}
          {...props}
        />
