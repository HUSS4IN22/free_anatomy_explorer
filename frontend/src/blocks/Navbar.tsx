...
export default function Navbar() {
  return (
    <header className="sticky top-4 z-50 mx-auto max-w-[95%] rounded-2xl border border-border/40 bg-background/95 shadow-sm backdrop-blur supports-[backdrop-filter:blur(0)]:bg-background/60">
